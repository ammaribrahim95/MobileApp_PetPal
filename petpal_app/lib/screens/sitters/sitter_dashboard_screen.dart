...
class _SitterDashboardScreenState extends State<SitterDashboardScreen>
  ...
  void initState() {
    ...
    if (user != null) {
      ...
      if ((user.servicesProvided == null || user.servicesProvided!.isEmpty) &&
  ...
  void _updateStatus(Booking booking, BookingStatus status, [String? reason]) {
    ...
    context.read<BookingBloc>().add(
      BookingStatusUpdated(updatedBooking, status),
    );
  }
          ...
          children: [
            Row(
              children: [
                CircleAvatar(
                  ...
                  child: image == null
                      ? Text(
                          booking.petName.isNotEmpty ? booking.petName[0] : '?',
                        )
                      : null,
                ),
            ...
            Row(
              children: [
                ...
                Text(
                  '${DateFormat('MMM d, y').format(booking.date)}${booking.endDate != null ? " - ${DateFormat('MMM d').format(booking.endDate!)}" : ""}',
                ),
              ],
            ),
