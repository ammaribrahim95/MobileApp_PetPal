          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ...pending.take(2).map((b) => _buildBookingTile(b, context)),
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: _imageProviderFromUrl(booking.petImageUrl) == null
                ? Text(booking.petName[0])
                : null,
          ),
          const SizedBox(width: 16),
          Expanded(
